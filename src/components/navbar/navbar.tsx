...
export const Navbar:FC<NavbarProps> = (props) =>{
    ...
    return <nav className="navbar-container">
        ...
        {props?.name ? <h1 className="navbar-name" role={'definition'}><a href="/"> {props.name}</a></h1> : null}
        ...
        {props?.copyright ? <p role={'article'} className="copyright">{props.copyright}</p> : null}
